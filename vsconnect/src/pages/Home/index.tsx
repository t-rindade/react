        ...
        <section className="container servicos">
          ...
          <div className="servicos_cards">
            <div className="card card1">
              ...
              <p>
                Possuo um Petshop e gostaria de um aplicativo para que meus
                clientes pudessem agendar serviços como: banho e tosa, taxi dog,
                hotelzinho e etc.
              </p>
            ...
            <div className="card card2">
              ...
              <p>
                Preciso de um site para divulgar o sabores das pizzas, o
                endereço, os telefones de contato, nossas redes sociais.
              </p>
